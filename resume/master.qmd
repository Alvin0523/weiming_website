...
m230060@e.ntu.edu.sg | +65 88252349 | \href{https://www.linkedin.com/in/wongweiming}{LinkedIn} | \href{https://github.com/Alvin0523}{GitHub} | Singaporean
\end{center}
...
- Relevant Modules (Master List — select ~6 for tailored applications): Data Structures & Algorithms, Algorithm Design & Analysis, Data Science & AI, Operating Systems, Software Engineering, Microprocessor System Design, Linear Algebra, Sensors & Digital Control
...
- **Robotics & Autonomy:** ROS 1 / ROS 2 (Isaac ROS), Nav2, NVBlox, MoveIt 2, ArduPilot, PX4, Behavior Trees, SLAM, Sensor Fusion (EKF/UKF), PID Control, rmw_zenoh
- **AI & Computer Vision:** PyTorch, LeRobot ($\pi_{0.5}$), Hugging Face, YOLO, OpenCV, Roboflow, TensorRT, ONNX
...
**National Service (NS), Singapore Armed Forces** \hfill \textbf{Jul 2021 – Present}

*Infantry Officer / Lieutenant (LTA) — HQ TRADOC*

- Currently serving in HQ TRADOC (Headquarters Training & Doctrine Command) for NSman reservist duties, contributing to training transformation, doctrine development, and operational readiness.
- Previously led and commanded an Infantry platoon during full-time NS, managing tactical field operations, personnel safety, and strategic logistics in high-pressure environments.
...
**UAV Trajectory Tracking & Visual-Inertial Odometry Evaluation** | \href{https://github.com/zhangone-smile/UAV-Trajectory-Tracking-VIO-Evaluation}{GitHub} \hfill \textbf{Feb 2026 – May 2026}

*HKUST ELEC5660 (Introduction to Aerial Robotics)*

- Built ROS 1 Noetic flight-test and evaluation stack for quadrotor UAVs, evaluating motion-capture EKF trajectory tracking across 5 3D flight profiles (circle, cosine, donut, figure-eight).
- Automated `evo` evaluation pipeline to benchmark VINS-Fusion and visual-EKF odometry drift against reference paths, computing Absolute Position Error (APE) and Relative Pose Error (RPE).
...
**NTU Student Ambassador (COE & CCDS)** \hfill \textbf{Aug 2024 – Present}

- Represented College of Engineering (COE) and Mecatron robotics team at institutional outreach, open house events, and technical showcases.
- Planned and conducted programming workshops for 20-30 BIM Scholar Programme students.
- Served as Sub-committee Member for **CCDS Tech for Good Hackathon 2026**, preparing LangChain workshop content and training materials for ~40 participants.

**NTU Sports Club** — Programmer \hfill \textbf{Aug 2023 – May 2024}

- Planned, organized, and executed annual NTU Sports Orientation events for incoming undergraduate students.

**NTU Varsity & Sports Clubs** \hfill \textbf{Aug 2023 – Present}

- **NTU Taekwondo Varsity Team:** Team Member (Aug 2023 – May 2024).
- **NTU Calisthenics Club:** Active Member (Aug 2023 – Present).

\newpage

## FYI — MASTER COPY NOTES & ATS GUIDELINES

**PDF Export Naming Convention**

- Recommended PDF File Name: **`resume_wongweiming(NTU).pdf`**

**Applicant Tracking System (ATS) Optimization Checklist**

- **Keyword Matching:** Ensure exact keywords from targeted Job Descriptions (e.g. ROS 2, Isaac ROS, MoveIt 2, PyTorch, C++, Embodied AI, SLAM) are explicitly present in SKILLS, EXPERIENCE, and PROJECTS sections.
- **Section Headers:** Keep standard heading titles (`EDUCATION`, `EXPERIENCE`, `PROJECTS & RESEARCH`, `SKILLS`, `ACHIEVEMENTS`) for parser compatibility.
- **Elaboration & Impact Links:** Every project and experience bullet should state the action verb, methodology/tools, and link to concrete results or top achievements listed above (e.g., SAUVC 2025 Champion, Robosub 2025 Top 10, HacX Finalist).

**CAO Guidelines Extracted from Reference Slides**

- **1. Quantifying Achievements (CAO Slide):**
  - **Specific Contributions:** Stress quantifiable outcomes in productivity, efficiency, quality, and product performance.
  - **Metrics Breakdown:** Incorporate numbers, percentages, dollar value, volume, grade, duration, and frequency.
  - **Duration / Time Period Examples:** *"for a period of 5 months"*, *"for a duration of 8 weeks"*.
  - **Frequency Examples:** Daily, weekly, bi-monthly, monthly, quarterly, half-yearly, annually.

- **2. Project Work & FYP Structure Template (CAO Slide):**
  - **Objective:** Describe the objective of the project/FYP in 1–2 sentences.
  - **Action Taken:** List specific actions taken (e.g., *"Research and compile relevant information for this FYP"*, *"Analyse and evaluate the information gathered"*).
  - **Testing & Prototyping:** Detail lab testing over defined periods (e.g., *"Conducted laboratory test over a period of 8 weeks and observed the engineering process"*) and prototype creation per engineering specifications.
  - **Outcomes & Results:** State final outcome, grade, thesis/theory proved, or quantitative performance metric achieved.

- **3. Hackathon Documentation Structure (CAO Slide):**
  - **Format:** `[Hackathon Name]` | `[Date]`
  - **Subtitle:** Concise tagline describing project goal (e.g., *"Simulated virtual clothing outfits with AI"*).
  - **Technical Implementation:** Action bullet with tech stack integration (e.g., OpenAI, DALL-E, Stable Diffusion, Python-Telegram-Bot).
  - **Team Leadership & Soft Skills:** Spearheading team directives, optimizing communication, workflow, and morale.
